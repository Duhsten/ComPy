...
{
    public static final ResourceLocation BACKGROUND_NORMAL = new ResourceLocation( Compy.MODID, "textures/gui/corners_normal.png" );
    public static final ResourceLocation BACKGROUND_ADVANCED = new ResourceLocation( Compy.MODID, "textures/gui/corners_advanced.png" );
    public static final ResourceLocation BACKGROUND_COMMAND = new ResourceLocation( Compy.MODID, "textures/gui/corners_command.png" );
    public static final ResourceLocation BACKGROUND_COLOUR = new ResourceLocation( Compy.MODID, "textures/gui/corners_colour.png" );
    ...
    public GuiRenderer( Matrix4f transform, IVertexBuilder builder, int z, float r, float g, float b )
    {
    ...
    @Nonnull
    public static ResourceLocation getTexture( @Nonnull ComputerType type )
    {
        switch( type )
        {
            case NORMAL:
    ...
    {
        new GuiRenderer( transform, buffer, z, r, g, b ).doRender( x, y, width, height, withLight );
    }
